...
module.exports = function(config) {
    ...
    var options = {
        ...
        default: {
            endpoint: config.endpoint ? config.endpoint : 'http://mason.ci',
            registry: config.registry = config.registry ? config.registry : 'registry.mason.ci',
    ...
    var mason = function(args){
        ...
        var commands = ["login", "logout", "whoami", "token", "self-update", "craft", "create", "deploy", "upgrade"];
