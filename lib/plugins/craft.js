 ...
 */ 
craft.compileDockerfile = function(templateFile, context) {

	// Get Dockerfile template
	var source = craft.getTemplateFile(templateFile || "./stubs/Dockerfile");
 ...
 */
craft.compileDockerCompose = function(templateFile, context) {
	
		// Get Dockerfile template
		var source = craft.getTemplateFile(templateFile || "./stubs/docker-compose.yml");
 ...
 */
craft.compileGitLabCI = function(templateFile, context) {
   
    // Get Dockerfile template
    var source = craft.getTemplateFile(templateFile || "./stubs/.gitlab-ci.yml");
